...
export default function Page() {
  ...
  useEffect(()=>{
    if(!sessionStorage.getItem("recruiterToken")){router.push("/dashboard/signin")}
  ...
  const fetchData = async () => {
    try {
      const response = await fetch(`/api/admin/jobs/fetch-recruiter-jobs?token=${sessionStorage.getItem("recruiterToken")}`, {
        method: "POST",

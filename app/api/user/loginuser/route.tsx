...
if(originalText!==password){
    return NextResponse.json({message:"Invalid Credentials",success:false},{status:400})
       ...
       const token:string= jwt.sign({_id: existingUserByMobile._id,name:existingUserByMobile.name,email:existingUserByMobile.email,user_type:existingUserByMobile.user_type}, process.env.AUTH_PASS!);

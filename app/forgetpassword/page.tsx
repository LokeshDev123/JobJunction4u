...
toast.success("OTP Sent Successfully",{duration:2000})
  ...
  const handleSubmit=async(e:FormEvent)=>{
    ...
    try {
      ...
      const response=await (await fetch(`/api/user/forgetpassword`,{
          
        headers:{
        "Content-Type":"application/json"
      
      },body:JSON.stringify({mobile_no:credentials.mobile_no,newpassword:credentials.password,cpassword:credentials.cpassword,authpasscode:process.env.NEXT_PUBLIC_AUTH_PASS}),method:"PUT"})).json()
